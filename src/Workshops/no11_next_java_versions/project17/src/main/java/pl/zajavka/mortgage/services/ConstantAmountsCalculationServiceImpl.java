...
public class ConstantAmountsCalculationServiceImpl implements ConstantAmountsCalculationService {
    ...
    public RateAmounts calculate(final InputData inputData, final Overpayment overpayment) {
        ...
        BigDecimal interestAmount =
                AmountsCalculationService.calculateInterestAmount(residualAmount, interestPercent);
        BigDecimal rateAmount =
                calculateConstantRateAmount(
                        q,
                        interestAmount,
                        residualAmount,
                        inputData.amount(),
        ...
        BigDecimal capitalAmount =
                AmountsCalculationService.compareCapitalWithResidual(
    ...
    private BigDecimal calculateConstantRateAmount(
        ...
        BigDecimal rateAmount = referenceAmount
            ...
            .divide(
                    q.pow(referenceDuration.intValue())
