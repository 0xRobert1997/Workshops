...
insert into car_dealership_user (user_id, user_name, email, password, active) values (8, 'test_user', 'fdsfsdf@zajavka.pl', '$2a$12$fIXKc0AvE.vNh7mnvnEbb.Am43hbDnB/23Srn0XOtK4CvuMvCvWEy', true);
