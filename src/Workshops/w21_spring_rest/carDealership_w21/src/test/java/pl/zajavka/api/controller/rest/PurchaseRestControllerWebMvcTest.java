...
public class PurchaseRestControllerWebMvcTest {
    ...
    private ObjectMapper objectMapper; //z paczki jacksona, do mapowania obj na jsony i z powrotem
    ...
    private static InvoiceDTO someInvoiceDTO() {
        return InvoiceDTO.builder()
                ...
                .dateTime(OffsetDateTime.of(2020, 10, 10, 10, 1, 11, 0, ZoneOffset.UTC))
                .build();
    }
}
