...
public class EmployeesController {
    ...
    public String updateEmployee(
        ...
        EmployeeEntity existingEmployee = employeeRepository.findById(employeeDTO.getEmployeeId())
                .orElseThrow(() -> new EntityNotFoundException(
                        String.format("EmployeeEntity not found, employeeId: [%s]", employeeDTO.getEmployeeId())));
