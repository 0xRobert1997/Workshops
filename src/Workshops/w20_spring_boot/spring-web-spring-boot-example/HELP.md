...
* The original package name 'pl.zajavka.spring-web-spring-boot-example' is invalid and this project uses 'pl.zajavka.springwebspringbootexample' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.0.8/reference/htmlsingle/#howto.data-initialization.migration-tool.flyway)
